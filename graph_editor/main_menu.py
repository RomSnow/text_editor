...
from graph_editor.file_history import UsingHistory
...
class MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.open_button.clicked.connect(self.main_window.main_func.open_button_func)
        # create_button
        ...
        self.create_button.clicked.connect(self.main_window.main_func.create_button_func)
        # label
        ...
        # last_use_layout
        self.main_window.last_use_layout = QtWidgets.QVBoxLayout(
            self.verticalLayoutWidget)
        self.main_window.last_use_layout.setContentsMargins(0, 0, 0, 0)
        self.main_window.last_use_layout.setObjectName("last_use_layout")
        # close_button
        self.close_button = QtWidgets.QPushButton(self.centralwidget)
        self.close_button.setGeometry(QtCore.QRect(30, 380, 281, 91))
        self.close_button.setObjectName("close_button")
        self.close_button.clicked.connect(self.main_window.main_func.close_button_func)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.close_button.setText(_translate("MainWindow", "Закрыть все"))
